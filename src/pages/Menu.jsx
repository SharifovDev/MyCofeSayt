  ...
  return (
    <div>
      ...
      <div className="lg:max-w-7xl md:max-w-2xl max-w-2xs mx-auto flex flex-wrap md:flex-nowrap justify-around mb-25 bg-{backdrop}">
        <div>
            <h1 className="lg:text-5xl md:text-2xl text-xl font-bold font-mono">Encontre o café perfeito <br /> para qualquer hora do dia</h1>
            <p className="lg:text-2xl hidden lg:block font-medium lg:my-6">Com o Coffee Delivery você recebe seu café onde estiver, a <br /> qualquer hora</p>
